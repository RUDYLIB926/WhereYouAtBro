...
public class BackgroundLoginTask extends AsyncTask<String, Void, String>{
    ...
    String register_url = "http://172.20.41.250/whereyouatbro/register.php";
    String login_url = "http://172.20.41.250/whereyouatbro/login.php";
    Context ctx;
    ...
    protected void onPostExecute(String json) {
        ...
        try {
            ...
            if (code.equals("reg_true")){
                ...
                Intent intent = new Intent(activity, DisplayList.class);
